    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="productos.php" class="list-group-item">Uniformes varones</a>
          <a href="productos.php" class="list-group-item">Uniformes chicas</a>
          <a href="productos.php" class="list-group-item">Accesorios</a>
        </div>
